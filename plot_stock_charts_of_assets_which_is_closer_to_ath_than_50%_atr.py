...
def plot_ohlcv_charts_with_breakout_of_ath_situations_entry_point_next_day (name_of_folder_where_plots_will_be,
    ...
    for row_with_level_formed_by_ath_and_ready_for_fast_breakout in range ( 0 , len ( table_of_tickers_with_fast_breakout_of_ath_df ) ):
        ...
        try:
            ...
            model = table_of_tickers_with_fast_breakout_of_ath_df.loc[
                row_with_level_formed_by_ath_and_ready_for_fast_breakout , 'model']
            print ( "crypto_ticker=" , crypto_ticker )
            ...
            try:
                ...
                fig.update_layout ( height = 1500 * number_of_charts ,
                                    ...
                                    title_text = f'{crypto_ticker} '
                                                 f'with level formed by ath={ath}'+'<br> '
                                                 f'"{model}"',
                                    font = dict (
                ...
                lower_border_of_atr  = ath + 0.5*advanced_atr
...
if __name__=="__main__":
    name_of_folder_where_plots_will_be = 'asset_approaches_its_ath_closer_than_50percent_atr'
    ...
    table_where_levels_formed_by_fast_breakout_of_ath_are_stored = "current_asset_approaches_its_ath_closer_than_n_percent_atr"
    try:
