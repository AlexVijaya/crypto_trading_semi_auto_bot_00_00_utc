...
def verify_that_asset_is_still_on_the_list_of_found_models_breakout_situations_of_atl_position_entry_on_day_two(stock_name):
    ...
    return trading_pair_still_satisfies_all_criteria
...
if __name__ == "__main__":
    ...
    if asset_still_satisfies_all_conditions==True:
        ...
        get_current_price_of_asset(exchange_object, trading_pair_with_slash_and_without_exchange)
        #buy or sell when next bar is printed

        # place_limit_sell_order_with_market_sl_and_limit_tp(exchange_id,
