...
def borrow_margin_loan_when_base_currency_is_borrowed(trading_pair,
    ...
    try:
        ...
        borrowed_margin_loan = exchange_object_where_api_is_required.borrowMargin(base,
            amount_of_base_currency, symbol=trading_pair, params=params)
...
def place_limit_order_with_sl_and_tp_with_constant_tracing_of_price_reaching_sl_or_tp_on_isolated_margin_account1(exchange_id,
                                                       trading_pair,
                                                       price_of_sl, type_of_sl, amount_of_sl,
                                                       price_of_tp, type_of_tp, amount_of_tp, post_only_for_limit_tp_bool,
                                                       price_of_limit_order, amount_of_asset_for_entry,side_of_limit_order):
    ...
    if side_of_limit_order == "buy":
        ...
        while True:
            ...
            print("limit_sell_order_status_on_isolated_margin3")
            print(limit_sell_order_status_on_isolated_margin)
...
if __name__=="__main__":
    ...
    price_of_limit_order=0.2496
    amount_of_asset_for_entry_in_quote_currency=5.0

    amount_of_asset_for_entry_in_base_currency=\
        convert_price_in_base_asset_into_quote_currency(amount_of_asset_for_entry_in_quote_currency,price_of_limit_order)

    amount_of_sl =amount_of_asset_for_entry_in_base_currency
    amount_of_tp=amount_of_asset_for_entry_in_base_currency
    side_of_limit_order="buy"
    # Print the values
    ...
    entry_price_is_between_sl_and_tp = \
        check_if_entry_price_is_between_sl_and_tp(price_of_sl, price_of_tp, price_of_limit_order,
                                                  side_of_limit_order)
    if entry_price_is_between_sl_and_tp:
        # place_limit_order_with_sl_and_tp_with_constant_tracing_of_price_reaching_sl_or_tp_on_spot_account(exchange_id,
        #                                                                                   trading_pair,
        ...
        #                                                                                   side_of_limit_order)
        #
        place_limit_order_with_sl_and_tp_with_constant_tracing_of_price_reaching_sl_or_tp_on_cross_margin_account1(exchange_id,
                                                                                                          trading_pair,
                                                                                                          price_of_sl,
                                                                                                          type_of_sl,
                                                                                                          amount_of_sl,
        ...
        # place_limit_order_with_sl_and_tp_with_constant_tracing_of_price_reaching_sl_or_tp_on_isolated_margin_account1(exchange_id,
        #                                                                                                   trading_pair,
        #                                                                                                   price_of_sl,
        #                                                                                                   type_of_sl,
        #                                                                                                   amount_of_sl,
