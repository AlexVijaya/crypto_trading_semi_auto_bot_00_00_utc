...
def insert_sl_tp_order_price_into_df(df_with_level_atr_bpu_bsu_etc,
    ...
    calculated_stop_loss = all_time_low - (
            0.05 * advanced_atr)
    distance_between_calculated_stop_loss_and_buy_order = buy_order - calculated_stop_loss
    take_profit_when_stop_loss_is_calculated_3_to_1 = buy_order + (buy_order - calculated_stop_loss) * 3
    take_profit_when_stop_loss_is_calculated_4_to_1 = buy_order + (buy_order - calculated_stop_loss) * 4
    ...
    # round calculated stop loss and take profit for ease of looking at
