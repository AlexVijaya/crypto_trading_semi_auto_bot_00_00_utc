...
def get_hisorical_data_from_exchange_for_many_symbols(list_of_crypto_plus_exchange,
...
def fetch_historical_usdt_pairs_asynchronously(list_of_crypto_plus_exchange,
    ...
    # coroutines = [get_hisorical_data_from_exchange_for_many_symbols(exchange ) for exchange in  exchanges_list]
    # asyncio.gather(*coroutines, return_exceptions = True)
    #
    usdt_trading_pair_number = 0
    counter = 0
    for exchange in exchanges_list:
        get_hisorical_data_from_exchange_for_many_symbols(list_of_crypto_plus_exchange, last_bitcoin_price, exchange,
                                                      counter,
                                                      engine, timeframe)
...
if __name__=="__main__":
    ...
    print(last_bitcoin_price)
    database_for_ohlcv_data="ohlcv_1d_data_for_usdt_pairs_0000"
    list_of_crypto_plus_exchange=\
