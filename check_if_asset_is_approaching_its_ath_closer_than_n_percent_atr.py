...
def check_if_asset_is_approaching_its_ath(percentage_between_ath_and_closing_price_of_atr,
...
if __name__=="__main__":
    percentage_between_ath_and_closing_price_of_atr = 50
    ...
    table_where_levels_formed_by_ath_will_be = "current_asset_approaches_its_ath_closer_than_n_percent_atr"
    ...
    check_if_asset_is_approaching_its_ath(percentage_between_ath_and_closing_price_of_atr,
                                          advanced_atr_over_this_period,
                                              db_where_ohlcv_data_for_stocks_is_stored,
                                              count_only_round_ath,
                                              db_where_levels_formed_by_ath_will_be,
