...
def search_for_tickers_with_breakout_situations(db_where_ohlcv_data_for_stocks_is_stored,
    ...
    #     connection_to_db_where_ticker_which_may_have_breakout_situations_no_drop = \
    #     connect_to_postgres_db_without_deleting_it_first(
    #         db_where_ticker_which_may_have_breakout_situations + "_no_drop")
    ...
    engine_for_db_where_ticker_which_may_have_breakout_situations_hist, \
        ...
        connect_to_postgres_db_without_deleting_it_first(
            db_where_ticker_which_may_have_breakout_situations + "_hist")
    ...
    table_where_ticker_which_may_have_breakout_situations_from_ath_or_atl_will_be = table_where_ticker_which_may_have_breakout_situations_from_atl_will_be
    list_of_already_processed_pairs, \
    ...
    for stock_name in list_of_tables_in_ohlcv_db:
        ...
        try:
            ...
            # if stock_name not in ['EOS_USDT_on_bigone',]:
            #     continue
...
#                    continue
    ...
    #               {'open': 6, 'high': 6, 'low': 6, 'close': 6, 'adjclose': 6})
                ...
                # if not stock_name=="SYS_USDT_on_mexc3":
                #     print("last_two_years_of_data_but_two_last_days1")
                #     print(last_two_years_of_data_but_two_last_days)
                #
                #     print("last_two_years_of_data_but_two_last_days.index")
                #     print(last_two_years_of_data_but_two_last_days.index)
                #
                #     print("last_two_years_of_data_but_two_last_days.index[-1]")
                #     print(last_two_years_of_data_but_two_last_days.index[-1])
                ...
                df_with_level_atr_bpu_bsu_etc.at[0, "model"] = "ПРОБОЙ_ATL_с_подтверждением_вход_на_2й_день"
                ...
                df_with_level_atr_bpu_bsu_etc.at[0, "timestamp_of_pre_breakout_bar"] = timestamp_of_pre_breakout_bar
                df_with_level_atr_bpu_bsu_etc.at[0, "human_date_of_pre_breakout_bar"] = date_of_pre_breakout_bar
                df_with_level_atr_bpu_bsu_etc.at[0, "open_of_pre_breakout_bar"] = open_of_pre_breakout_bar
                df_with_level_atr_bpu_bsu_etc.at[0, "high_of_pre_breakout_bar"] = high_of_pre_breakout_bar
                df_with_level_atr_bpu_bsu_etc.at[0, "low_of_pre_breakout_bar"] = low_of_pre_breakout_bar
                df_with_level_atr_bpu_bsu_etc.at[0, "close_of_pre_breakout_bar"] = close_of_pre_breakout_bar
                df_with_level_atr_bpu_bsu_etc.at[0, "volume_of_pre_breakout_bar"] = volume_of_pre_breakout_bar
                ...
                df_with_level_atr_bpu_bsu_etc.at[0, "distance_between_calculated_sl_and_sell_order_in_atr"] = \
                    distance_between_calculated_stop_loss_and_sell_order_in_atr
                df_with_level_atr_bpu_bsu_etc.at[0, "distance_between_calculated_sl_and_sell_order"] = \
