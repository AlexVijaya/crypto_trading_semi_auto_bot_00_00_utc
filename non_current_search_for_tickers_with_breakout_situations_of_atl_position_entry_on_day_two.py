...
#                    continue
    ...
    #               {'open': 6, 'high': 6, 'low': 6, 'close': 6, 'adjclose': 6})
                ...
                df_with_level_atr_bpu_bsu_etc.loc[
                    0, "model"] = "ПРОБОЙ_ATL_с_подтверждением_вход_на_2й_день"
                df_with_level_atr_bpu_bsu_etc.loc[
                    0, "atl"] = all_time_low
                df_with_level_atr_bpu_bsu_etc.loc[
                ...
                df_with_level_atr_bpu_bsu_etc.loc[
                    0, "timestamp_of_breakout_bar"] = timestamp_of_breakout_bar
                df_with_level_atr_bpu_bsu_etc.loc[
                ...
                df_with_level_atr_bpu_bsu_etc.loc[
                    0, "distance_between_calculated_sl_and_sell_order_in_atr"] = \
                    distance_between_calculated_stop_loss_and_sell_order_in_atr
                df_with_level_atr_bpu_bsu_etc.loc[
                    0, "distance_between_calculated_sl_and_sell_order"] = \
                ...
                try:
                    df_with_level_atr_bpu_bsu_etc.loc[0, "final_position_entry_price"]= sell_order
                    df_with_level_atr_bpu_bsu_etc.loc[0, "final_stop_loss_price"] = technical_stop_loss
                    df_with_level_atr_bpu_bsu_etc.loc[0, "final_position_entry_price_default_value"] = sell_order
                ...
                try:
                    ...
                    df_with_level_atr_bpu_bsu_etc=add_to_df_result_of_return_bool_whether_technical_sl_tp_and_sell_order_have_been_reached(
                        df_with_level_atr_bpu_bsu_etc,
                        index_in_iteration,
                    ...
                    df_with_level_atr_bpu_bsu_etc=add_to_df_result_of_return_bool_whether_calculated_sl_tp_and_sell_order_have_been_reached(
                        df_with_level_atr_bpu_bsu_etc,
                        index_in_iteration,
                        entire_original_table_with_ohlcv_data_df,
                        side,
