...
def verify_that_asset_is_still_on_the_list_of_found_models_rebound_situations_off_ath(stock_name,
                                                                                                timeframe,
                                                                                                last_bitcoin_price,
    ...
    if stock_name in list_with_tickers_ready_for_rebound_off_atl:
        ...
        return False
def verify_that_asset_is_still_on_the_list_of_found_models_rebound_situations_off_atl(stock_name,
                                                                                                timeframe,
                                                                                                last_bitcoin_price,
                                                                                                advanced_atr_over_this_period,
                                                                                      acceptable_backlash):
    ...
    if stock_name in list_with_tickers_ready_for_rebound_off_atl:
        ...
        return False
def verify_that_asset_is_still_on_the_list_of_found_models_false_breakout_situations_of_atl_by_one_bar(stock_name,
                                                                                                timeframe,
                                                                                                last_bitcoin_price,
                                                                                                advanced_atr_over_this_period):
    list_of_tables_in_ohlcv_db = [stock_name]
...
def verify_that_asset_is_still_on_the_list_of_found_models_false_breakout_situations_of_ath_by_one_bar(stock_name,
                                                                                                timeframe,
                                                                                                last_bitcoin_price,
                                                                                                advanced_atr_over_this_period):
    list_of_tables_in_ohlcv_db = [stock_name]
...
def verify_that_asset_is_still_on_the_list_of_found_models_false_breakout_situations_of_atl_by_two_bars(stock_name,
                                                                                                timeframe,
                                                                                                last_bitcoin_price,
                                                                                                advanced_atr_over_this_period):
    list_of_tables_in_ohlcv_db = [stock_name]
    ...
    if stock_name in list_of_stocks_which_broke_atl:
        ...
        return False
def verify_that_asset_is_still_on_the_list_of_found_models_false_breakout_situations_of_ath_by_two_bars(stock_name,
                                                                                                timeframe,
                                                                                                last_bitcoin_price,
                                                                                                advanced_atr_over_this_period):
    list_of_tables_in_ohlcv_db = [stock_name]
...
def verify_that_asset_is_still_on_the_list_of_found_models_breakout_situations_of_ath_position_entry_on_day_two(stock_name,
                                                                                                                     timeframe,
                                                                                                                     last_bitcoin_price,
                                                                                                                     advanced_atr_over_this_period):
    list_of_tables_in_ohlcv_db = [stock_name]
...
def verify_that_asset_is_still_on_the_list_of_found_models_breakout_situations_of_ath_position_entry_on_the_next_day(stock_name,
                                                                                                                     timeframe,
                                                                                                                     last_bitcoin_price,
                                                                                                                     advanced_atr_over_this_period):
    list_of_tables_in_ohlcv_db = [stock_name]
    ...
    if stock_name in list_of_stocks_which_broke_atl:
        ...
        return False
def verify_that_asset_is_still_on_the_list_of_found_models_breakout_situations_of_atl_position_entry_on_the_next_day(stock_name,
                                                                                                                     timeframe,
                                                                                                                     last_bitcoin_price,
                                                                                                                     advanced_atr_over_this_period):
    list_of_tables_in_ohlcv_db=[stock_name]
...
def fetch_dataframe_from_google_spreadsheet(spread_sheet_title):
    ...
    print(df_from_sheet)
    st.write("df_from_sheet1")
    st.write(df_from_sheet)
...
if __name__=="__main__":
    ...
    column_name_list_which_must_be_converted_from_str_to_bool=\
        ["stop_loss_is_technical","stop_loss_is_calculated"]
    ...
    while True:
        ...
        if not check_if_utc_midnight_has_arrived():
