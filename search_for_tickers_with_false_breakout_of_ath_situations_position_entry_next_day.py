...
def insert_sl_tp_order_price_into_df(df_with_level_atr_bpu_bsu_etc,
    ...
    timestamp_of_false_breakout_bar = table_with_ohlcv_data_df_slice_numpy_array[number_of_last_row_in_np_array_row_slice][0]
    ...
    close_of_false_breakout_bar = table_with_ohlcv_data_df_slice_numpy_array[number_of_last_row_in_np_array_row_slice][4]
    volume_of_false_breakout_bar = table_with_ohlcv_data_df_slice_numpy_array[number_of_last_row_in_np_array_row_slice][5]
                                ...
                                if number_of_last_row_in_np_array_row_slice>row_of_last_ath_which_is_limit_level_also+\
                                    ...
                                    try:
                                        ...
                                        if open_of_false_breakout_bar and close_of_false_breakout_bar:
                                                    ...
                                                    if (distance_between_current_ath_and_false_breakout_bar_open > advanced_atr * 0.05) and\
                                                        ...
                                                        if open_of_bar_next_day_after_false_breakout_bar:
                                                            if (close_of_false_breakout_bar>open_of_bar_next_day_after_false_breakout_bar) and \
                                                                ...
                                                                df_with_level_atr_bpu_bsu_etc.loc[
                                                                    0, "timestamp_of_bar_next_day_after_false_breakout_bar"] = timestamp_of_bar_next_day_after_false_breakout_bar
                                                                df_with_level_atr_bpu_bsu_etc.loc[
                                                                    0, "position_entry_timestamp"] = timestamp_of_bar_next_day_after_false_breakout_bar
                                            ...
                                            df_with_level_atr_bpu_bsu_etc.at[0 , "open_of_bar_next_day_after_false_breakout_bar"] = open_of_bar_next_day_after_false_breakout_bar
