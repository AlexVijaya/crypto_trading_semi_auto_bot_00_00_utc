...
def search_for_tickers_with_false_breakout_situations(db_where_ohlcv_data_for_stocks_is_stored,
    ...
    #     connect_to_postgres_db_without_deleting_it_first ( db_where_ticker_which_may_have_fast_false_breakout_situations )
    #
    ...
    #         db_where_ticker_which_may_have_fast_false_breakout_situations + "_no_drop")
    ...
    engine_for_db_where_ticker_which_may_have_fast_breakout_situations_hist, \
        ...
        connect_to_postgres_db_without_deleting_it_first(
            db_where_ticker_which_may_have_fast_false_breakout_situations + "_hist")
