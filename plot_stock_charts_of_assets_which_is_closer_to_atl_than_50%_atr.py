...
def import_ohlcv_and_levels_formed_by_lows_for_plotting(crypto_ticker,
...
def plot_ohlcv_charts_with_breakout_of_atl_situations_entry_point_next_day (name_of_folder_where_plots_will_be,
    ...
    for row_with_level_formed_by_atl_and_ready_for_fast_breakout in range ( 0 , len ( table_of_tickers_with_fast_breakout_of_atl_df ) ):
        ...
        try:
            ...
            crypto_ticker = table_of_tickers_with_fast_breakout_of_atl_df.loc[row_with_level_formed_by_atl_and_ready_for_fast_breakout , 'ticker']
            ...
            data_df = import_ohlcv_and_levels_formed_by_lows_for_plotting ( crypto_ticker ,
                                                                            connection_to_crypto_tickers_ohlcv )
            ...
            print ( f'{crypto_ticker} on {exchange} is number {row_with_level_formed_by_atl_and_ready_for_fast_breakout + 1} '
            ...
            try:
                ...
                lower_border_of_atr  = atl + 0.5*advanced_atr
                ...
                #
                #     data_df_slice_seq_sell_several_last_days_are_left_exceed_low_true = \
                #         data_df_slice_seq_sell_several_last_days_are_left.loc[
                #             (data_df_slice_seq_sell_several_last_days_are_left["seq_sell"] == 9) & (
                #                     data_df_slice_seq_sell_several_last_days_are_left["exceed_low"] == True)]
                #
                #     print("data_df_slice_seq_sell_several_last_days_are_left_exceed_low_true")
                #     print ( data_df_slice_seq_sell_several_last_days_are_left_exceed_low_true.to_string() )
                #     # print ( "data_df_slice_seq_sell" )
                #     # print ( data_df_slice_seq_sell.to_string () )
                #
                #     for row_number in range(0,len(data_df_slice_seq_sell_several_last_days_are_left_exceed_low_true)):
                #         try:
                #             fig.add_scatter ( x = [data_df_slice_seq_sell_several_last_days_are_left_exceed_low_true["open_time"].iat[row_number] ],
                #                               y = [data_df_slice_seq_sell_several_last_days_are_left_exceed_low_true["high"].iat[row_number]],
                #                               mode = "markers" ,
                ...
                try:
                    fig.add_annotation ( text =
                                         ...
                                         # # f" | distance_between_atl_and_open_of_breakout_bar={open_of_breakout_bar_is_away_from_atl_in_percentage} %ATR"
