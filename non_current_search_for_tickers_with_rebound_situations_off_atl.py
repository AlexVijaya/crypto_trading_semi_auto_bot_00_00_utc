...
def create_string_for_output_to_file_for_stock_rebound_from_atl(stock_name,
    ...
    take_profit_when_sl_is_calculated_3_to_1 = buy_order + (advanced_atr * 0.5) * 3
    take_profit_when_sl_is_calculated_4_to_1 = buy_order + (advanced_atr * 0.5) * 4
...
def search_for_tickers_with_rebound_situations(db_where_ohlcv_data_for_stocks_is_stored,
    ...
    table_where_ticker_which_may_have_rebound_situations_from_ath_or_atl_will_be = table_where_ticker_which_had_rebound_situations_from_atl_will_be
    list_of_already_processed_pairs, \
            ...
            if len(ohlcv_df_with_low_equal_to_atl_slice)>1:
                ...
                if advanced_atr>0:
                    ...
                    if (backlash <= advanced_atr * acceptable_backlash) and ( low_of_bpu2 - all_time_low )>=0:
                        ...
                        df_with_level_atr_bpu_bsu_etc.at[0 , "true_low_of_bsu"] = true_low_of_bsu
                        df_with_level_atr_bpu_bsu_etc.at[0 , "true_low_of_bpu1"] = true_low_of_bpu1
                        df_with_level_atr_bpu_bsu_etc.at[0 , "true_low_of_bpu2"] = true_low_of_bpu2
                        ...
                        try:
                            ...
                            df_with_level_atr_bpu_bsu_etc = add_to_df_result_of_return_bool_whether_calculated_sl_tp_and_buy_order_have_been_reached(level_price,
                                advanced_atr,
                                df_with_level_atr_bpu_bsu_etc,
                                index_in_iteration,
