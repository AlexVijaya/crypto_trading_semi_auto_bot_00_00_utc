...
def plot_ohlcv_chart_with_levels_formed_by_rebound_off_atl (name_of_folder_where_plots_will_be,
    ...
    for row_with_level_formed_by_rebound_off_atl in range ( 0 , len ( table_of_levels_formed_by_rebound_off_atl_df ) ):
        ...
        try:
            ...
            crypto_ticker = table_of_levels_formed_by_rebound_off_atl_df.loc[row_with_level_formed_by_rebound_off_atl , 'ticker']
            exchange = table_of_levels_formed_by_rebound_off_atl_df.loc[row_with_level_formed_by_rebound_off_atl , 'exchange']
            model = table_of_levels_formed_by_rebound_off_atl_df.loc[row_with_level_formed_by_rebound_off_atl , 'model']
            print ( "crypto_ticker=" , crypto_ticker )
            ...
            print ( f'{crypto_ticker} on {exchange} is number {row_with_level_formed_by_rebound_off_atl + 1} '
...
if __name__=="__main__":
    ...
    db_where_levels_formed_by_rebound_off_atl_are_stored="levels_formed_by_highs_and_lows_for_cryptos_0000"
    table_where_levels_formed_by_rebound_off_atl_are_stored = "current_rebound_situations_from_atl"
    try:
