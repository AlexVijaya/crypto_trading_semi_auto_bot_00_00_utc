...
# #######################################################3
                    ...
                    if current_timestamp_minus_last_timestamp_in_df_in_days>=limit_of_daily_candles:
                        ...
                        ####################################
                        try:
                            spot_asset_also_available_as_swap_contract_on_same_exchange_bool=table_with_ohlcv_data_df["spot_asset_also_available_as_swap_contract_on_same_exchange"].iat[0]
                            ohlcv_data_several_last_rows_df['spot_asset_also_available_as_swap_contract_on_same_exchange'] = spot_asset_also_available_as_swap_contract_on_same_exchange_bool
                        except:
                            ohlcv_data_several_last_rows_df['spot_asset_also_available_as_swap_contract_on_same_exchange'] = np.nan

                        try:
                            url_of_swap_contract_if_it_exists_bool=table_with_ohlcv_data_df["url_of_swap_contract_if_it_exists"].iat[0]
                            ohlcv_data_several_last_rows_df['url_of_swap_contract_if_it_exists'] = url_of_swap_contract_if_it_exists_bool
                        except:
