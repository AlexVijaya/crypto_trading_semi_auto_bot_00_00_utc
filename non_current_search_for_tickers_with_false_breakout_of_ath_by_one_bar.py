...
def search_for_tickers_with_breakout_situations(db_where_ohlcv_data_for_stocks_is_stored,
    ...
    #
    # engine_for_db_where_ticker_which_may_have_false_breakout_situations_no_drop, \
    ...
    engine_for_db_where_ticker_which_may_have_false_breakout_situations_hist, \
    ...
    for stock_name in list_of_tables_in_ohlcv_db:
        ...
        try:
            ...
            # if stock_name!="AVAX_USDT_on_bigone":
            #     continue
...
#                    continue
    ...
    #               {'open': 6, 'high': 6, 'low': 6, 'close': 6, 'adjclose': 6})
                ...
                df_with_level_atr_bpu_bsu_etc.at[0, "model"] = "ЛОЖНЫЙ_ПРОБОЙ_ATH_1Б"
