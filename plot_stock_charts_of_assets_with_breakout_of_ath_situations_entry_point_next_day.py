...
if __name__=="__main__":
    name_of_folder_where_plots_will_be = 'breakout_of_ath_entry_point_next_day'
    ...
    table_where_levels_formed_by_fast_breakout_of_ath_are_stored = "current_breakout_situations_of_ath_position_entry_next_day"
    try:
