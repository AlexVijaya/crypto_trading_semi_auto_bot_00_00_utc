...
def plot_ohlcv_chart_with_levels_formed_by_fast_breakout_off_atl (name_of_folder_where_plots_will_be,
    ...
    for row_with_level_formed_by_atl_and_ready_for_fast_breakout in range ( 0 , len ( table_of_tickers_with_fast_breakout_of_atl_df ) ):
        ...
        try:
            ...
            model = table_of_tickers_with_fast_breakout_of_atl_df.loc[row_with_level_formed_by_atl_and_ready_for_fast_breakout , 'model']
            print ( "crypto_ticker=" , crypto_ticker )
...
if __name__=="__main__":
    ...
    table_where_levels_formed_by_fast_breakout_of_atl_are_stored = "current_fast_breakout_situations_of_atl"
    try:
