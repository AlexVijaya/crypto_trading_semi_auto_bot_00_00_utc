...
def run_multiple_search_current_rebound_breakout_false_breakout_situations():
    ...
    print(interpreter)
    files = ['non_current_search_for_tickers_with_breakout_situations_of_ath_position_entry_next_day.py',
             'non_current_search_for_tickers_with_breakout_situations_of_ath_position_entry_on_day_two.py',
             'non_current_search_for_tickers_with_breakout_situations_of_atl_position_entry_next_day.py',
             'non_current_search_for_tickers_with_breakout_situations_of_atl_position_entry_on_day_two.py',
             'non_current_search_for_tickers_with_false_breakout_of_ath_by_one_bar.py',
             'non_current_search_for_tickers_with_false_breakout_of_ath_by_two_bars.py',
             'non_current_search_for_tickers_with_false_breakout_of_atl_by_one_bar.py',
             'non_current_search_for_tickers_with_false_breakout_of_atl_by_two_bars.py',
             'non_current_search_for_tickers_with_rebound_situations_off_ath.py',
             'non_current_search_for_tickers_with_rebound_situations_off_atl.py',
