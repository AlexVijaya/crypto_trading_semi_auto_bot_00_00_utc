...
def search_for_tickers_with_breakout_situations(db_where_ohlcv_data_for_stocks_is_stored,
    ...
    #     connect_to_postgres_db_without_deleting_it_first(db_where_ticker_which_may_have_breakout_situations+"_no_drop")
...
#                    continue
    ...
    #               {'open': 6, 'high': 6, 'low': 6, 'close': 6, 'adjclose': 6})
                ...
                df_with_level_atr_bpu_bsu_etc.at[0, "model"] = "ПРОБОЙ_ATL_с_подтверждением_вход_на_следующий_день"
